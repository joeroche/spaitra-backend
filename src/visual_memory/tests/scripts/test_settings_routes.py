...
def test_get_settings_fields():
    ...
    assert data.get("scan_similarity_margin") == _pm._settings.scan_similarity_margin
    assert data.get("scan_similarity_margin_document") == _pm._settings.scan_similarity_margin_document
